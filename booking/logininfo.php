                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                      ...
                      <div style="float:right">  
                         ...
                         <div class="col-md-12" >
                              <label>Total:</label>
                            <?php echo ' &#8378 '.   $_SESSION['monbela_cart'][$i]['monbelaroomprice']; ?>
                         </div> 
...
?>
      <div class="col-md-12" >
      <div class="row">
          <label style="float:left">Overall Price</label> <h2 style="float:right"> &#8378 <?php echo   $_SESSION['pay'] ;?></h2> 
      </div>
        </div>
