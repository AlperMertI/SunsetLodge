...
<title><?php echo isset($title) ? $title . ' | Sunset Lodge' :  'Sunset Lodge' ; ?></title>
  ...
  <div id="header-wrap" class="clr fixed-header">
    <header id="header" class="site-header clr">
      ...
      <div id="logo" class="clr">
        ...
        <h2 id="site-name">
          <a href="<?php echo WEB_ROOT; ?>index.php" title="Sunset Lodge">Sunset Lodge</a>
...
<div id="homepage-slider-wrap" class="clr flexslider-container">
    <div id="homepage-slider" class="flexslider">
      <ul class="slides clr">
       <li>
            <img src="<?php echo WEB_ROOT; ?>images/hotel-banner.jpg">
        </li>
