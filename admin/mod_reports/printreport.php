...
<title><?php echo isset($title) ? $title . ' | Monbela Tourist Inn' :  'Sunset Lodge' ; ?></title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i>Sunset Lodge
		...
		if ($row_count >0){
          ...
          $days =  dateDiff(date($result->ARRIVAL),date($result->DEPARTURE));
            ...
            <tr> 
              ...
              <td> &#8378 <?php echo $result->PRICE;?></td>
              ...
              <td> &#8378 <?php echo $result->RPRICE;?></td>
            </tr>
