                  ...
                  <div id="roomimg" class="col-md-4 img-portfolio">
                    ...
                    <a href="#" >
                        <figure class="gallery-item ">
                            ...
                            <img class="img-responsive img-hover"  src="<?php echo WEB_ROOT .'admin/mod_room/rooms'.$result->ROOMIMAGE; ?>">
                            <?php else: ?>
                            <img class="img-responsive img-hover"  src="<?php echo WEB_ROOT .'images/premium-room.jpg'; ?>">
                            <?php endif; ?>
                    
                             <!-- <?php echo $img_title; ?> -->
                            <figcaption class="img-title-active">
                                <h5> &#8378 <?php echo $result->PRICE ;?></h5>    
                            </figcaption>
